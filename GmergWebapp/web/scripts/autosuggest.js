...
function AutoSuggest(elem, suggestions)
{
	...
	********************************************************/
	...
	/********************************************************
	Offer suggestions for each item in a \n separated list
    ********************************************************/
	...
	********************************************************/
	this.changeHighlight = function()
	{
		...
		for (var i = 0;  i < lis.length; i++) //(i in lis)
		{
			var li = lis[i];
	...
	this.getEligible = function()
	{
		...
		for (i in this.suggestions) 
		{
			...
			if((suggestion.toLowerCase().indexOf(this.inputText.toLowerCase()) == "0" ||
			       suggestion.toLowerCase().indexOf(" "+this.inputText.toLowerCase()) > 0) && suggestion.toLowerCase() != this.inputText.toLowerCase())
			{
