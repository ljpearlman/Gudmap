...
public interface AdvancedQueryDAO {
	...
	public ArrayList<String []> getFocusQuery(String type, String[] input, int orderby, 
			...
			String sub, String exp, String[] queryCriteria, String transitiveRelations, String archiveId, String batchId, GenericTableFilter filter);
	// Bernie - 9/5/2011 - Mantis 328 - added filter
    public int getNumberOfRows(String type, String[] input, String organ, String sub, String exp, String[] queryCriteria, String transitiveRelations, String archiveId, String batchId, GenericTableFilter filter);
