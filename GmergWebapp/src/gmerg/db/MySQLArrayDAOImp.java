...
public class MySQLArrayDAOImp implements ArrayDAO {
	...
	if (performance) {
	    enter = (System.currentTimeMillis() - enter)/1000;
	    if (2 < enter)
		System.out.println("MySQLArrayDAOImp.findSeriesBySubmissionId takes " + enter+" seconds");
	}
	...
	if (performance) {
	    enter = (System.currentTimeMillis() - enter)/1000;
	    if (2 < enter)
		System.out.println("MySQLArrayDAOImp.getTransgenicInfoBySubmissionId takes " + enter+" seconds");
	}
