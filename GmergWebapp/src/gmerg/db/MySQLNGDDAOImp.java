...
import gmerg.entities.submission.array.NGDSample;
 ...
 *
 */
public class MySQLNGDDAOImp implements NGDDAO {
    ...
    public String getTotalNumberOfSubmission() {
		...
		try {
			...
			if (performance) {
			    ...
			    if (2 < enter)
			    	System.out.println("MySQLNGDDAOImp.getTotalNumberOfSubmission takes " + enter+" seconds");
			}
    ...
    public String[][] getStringArrayFromBatchQuery(String[][] param, String[] query) {
		...
		try {
		    ...
		    for (int i=0;i<queryNumber;i++) {
			if (debug)
			    System.out.println("MySQLNGDDAOImp.sql = "+queryString[i].toLowerCase());
			...
			if ( param != null && param[i] != null) { // set query criteria if it's not null
				...
				if (debug)
				    System.out.println("MySQLNGDDAOImp. "+(j+1)+" arg = "+param[i][j]);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getStringArrayFromBatchQuery takes " + enter+" seconds");
			}
		}
    }
    ...
    public Platform findPlatformBySubmissionId(String submissionAccessionId) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.findPlatformBySubmissionId takes " + enter+" seconds");
			}
		}
    }
    ...
    public String getTotalNumberOfGeneListItemsBySubmissionId(String submissionAccessionId) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getTotalNumberOfGeneListItemsBySubmissionId takes " + enter+" seconds");
			}
		}
    }
    ...
    public int getRowNumOf1stOccurrenceOfGeneInArrayGeneList(String accessionId, String geneSymbol) {
		...
		try {
		    ...
		    prepStmt = parQ.getPrepStat();
		    if (debug)
		    	System.out.println("MySQLNGDDAOImp 1 arg = "+accessionId);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getRowNumOf1stOccurrenceOfGeneInArrayGeneList takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList getSubmissionsByLabId(String labId, String submissionDate,
		...
		try {
		    ...
		    if (debug)
		    	System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase());
		    prepStmt = conn.prepareStatement(queryString);
		    
		    if (submissionDate == null || submissionDate.equals("")) {
				if (debug)
				    System.out.println("MySQLNGDDAOImp 1 arg = "+lab);
				prepStmt.setInt(1, lab);
		    } else {
				if (debug)
				    System.out.println("MySQLNGDDAOImp 1 arg = "+ labId+" 2 arg = "+submissionDate);
			...
			if (debug)
			    System.out.println("MySQLNGDDAOImp prepStmt = "+ prepStmt);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp. getSubmissionsByLabId takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList getSubmissionsByLabId(String labId, String submissionDate, String archiveId,
		...
		try {
		    ...
		    if (labId != null && !labId.trim().equals("")) {
				if (debug)
				    System.out.println("MySQLNGDDAOImp  arg = "+labId);
		    ...
		    if (submissionDate != null && !submissionDate.equals("")) {
				if (debug)
				    System.out.println("MySQLNGDDAOImp  arg = "+submissionDate);
		    ...
		    if (archiveId != null && !archiveId.trim().equals("")) {
				if (debug)
				    System.out.println("MySQLNGDDAOImp  arg = "+archiveId);
		    ...
		    if (batchId != null && !batchId.trim().equals("")) {
				if (debug)
				    System.out.println("MySQLNGDDAOImp  arg = "+batchId);
    ...
    public String[][] findSampleIdsBySeriesId(String seriesId) {
		...
		try {
		    ...
		    prepStmt = parQ.getPrepStat();
		    if (debug)
			System.out.println("MySQLNGDDAOImp 1 arg = "+seriesId);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.findSampleIdsBySeriesId takes " + enter+" seconds");
			}
		}
    }
    ...
    public DataSet getAnalysisDataSetBySampleIds(String[][] samplesInfo) {
		...
		try {
		    ...
		    for(int col=0; col<sampleNo; col++) {
				if (debug)
				    System.out.println("MySQLNGDDAOImp 1 arg = "+samplesInfo[col][0]);
		    ...
		    prepStmt = parQ.getPrepStat();
		    if (debug)
			System.out.println("MySQLNGDDAOImp 1 arg = "+samplesInfo[0][0]);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getAnalysisDataSetBySampleIds takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList getAllSeriesGEOIds() {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getAllSeriesGEOIds takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList getComponentListByName(String componentName) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getComponentListByName takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList getGenelistHeadersByComponentNames(ArrayList componentNames) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getGenelistHeadersByComponentNames takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList getGenelistHeadersByLabId(String labId) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getGenelistHeadersByLabId takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList<SearchLink> getGenelistExternalLinks() {
		...
		try {
		    ...
		    prepStmt = parQ.getPrepStat();
		    if (debug)
			System.out.println("MySQLNGDDAOImp:getGenelistExternalLinks sql = "+prepStmt);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getGenelistExternalLinks takes " + enter+" seconds");
			}
		}
    }
    ...
    public Object[][] getGenelistItemsByGenelistId(int genelistId) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getGenelistItemsByGenelistId takes " + enter+" seconds");
			}
		}
    }
    ...
    public Object[][] getGenelistItemsByGenelistId(int genelistId, int columnId, boolean ascending, int offset, int num) {
		...
		try {
		    ...
		    if (debug)
			System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase()+" 1 arg = "+genelistId);
		    prepStmt = conn.prepareStatement(queryString);
		    prepStmt.setInt(1, genelistId);
		    resSet = prepStmt.executeQuery();
    ...
    public int getGenelistsEntryNumber(int genelistId) {
	    ...
	    conn = DBHelper.reconnect2DB(conn);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getGenelistsEntryNumber takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList<String> getProbeSetIdBySymbol(String symbol, String platformId) {
		...
		try {
		    ...
		    if (debug)
			System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase() + "1 arg = "+symbol+" 2 arg = "+platformId);
		    prepStmt = conn.prepareStatement(queryString);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getProbeSetIdBySymbol takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList<String> getProbeSetIdByAnalysisGenelistId(String genelistId, 
		...
		try {
		    ...
		    if (debug) 
		    	System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase() +" 1 arg = "+glstId);
			...
			if (debug)
			    System.out.println("MySQLNGDDAOImp.sql 2 arg = "+clstId);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getProbeSetIdByAnalysisGenelistId takes " + enter+" seconds");
			}
		}
    }
    ...
    public String getAnalysisGenelistTitle(String genelistId) {
		...
		try {
		    ...
		    if (clstId == null) {
			if (debug)
			    System.out.println("MySQLNGDDAOImp.sql 1 arg = "+glstId);
			prepStmt.setInt(1, Integer.parseInt(glstId));
		    } else {
				if (debug)
				    System.out.println("MySQLNGDDAOImp.sql 1 arg = "+clstId);
    ...
    public HeatmapData getExpressionByGivenProbeSetIds(ArrayList probeSetIds, 
		...
		if (debug)
		    System.out.println("MySQLNGDDAOImp.getExpressionByGivenProbeSetIds masterTableId = "+masterTableId+" genelistId = "+genelistId);
		...
		if (probeSetIds != null && probeSetIds.size() != 0 
		    ...
		    try {
				...
				if (debug)
				    System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase()+" 1 arg = "+masterTableAndSectionId[0]+" 2 arg = "+masterTableAndSectionId[1]);
				...
				if (debug)
				    System.out.println("MySQLNGDDAOImp.sql = "+prepStmt);
				...
				if (performance) {
				    enter = (System.currentTimeMillis() - enter)/1000;
				    if (2 < enter)
					System.out.println("MySQLNGDDAOImp.getExpressionByGivenProbeSetIds takes " + enter+" seconds");
				}
			}
		}
		return expressions;
    ...
    private HeatmapData formatExpressionByProbeSetIdsResultSet(ResultSet resSet, 
		...
		if (debug)
			System.out.println("MySQLNGDDAOImp.formatExpressionByProbeSetIdsResultSet probeSetNumber: " + probeSetNumber);
		...
		if (resSet.first()) {
			...
			if (debug) 
				System.out.println("MySQLNGDDAOImp.formatExpressionByProbeSetIdsResultSet expressions size = "+expressions.length+" medianValues size = "+medianValues.length+" stdValues size = "+stdValues.length);
    ...
    public ArrayList<String> getExpressionSortedByGivenProbeSetIds(ArrayList probeSetIds, 
		...
		if (probeSetIds != null && probeSetIds.size() != 0) {
		    ...
		    try {
				...
				if (debug)
				    System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase()+" 1 arg = "+columnId);
				prepStmt = conn.prepareStatement(queryString);
				...
				if (performance) {
				    enter = (System.currentTimeMillis() - enter)/1000;
				    if (2 < enter)
					System.out.println("MySQLNGDDAOImp.getExpressionSortedByGivenProbeSetIds takes " + enter+" seconds");
				}
			}
		}
		return expressions;
	...
	//        System.out.println("array:findGeneInfoBySymbol query: " + queryString);
        ...
        try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.findGeneInfoBySymbol takes " + enter+" seconds");
			}
		}
    }
    ...
    public MasterTableInfo[] getMasterTableList(boolean isMaster) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp. getMasterTableListtakes " + enter+" seconds");
			}
		}
    }
    ...
    public MasterTableInfo[] getMasterTableList() {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getMasterTableList takes " + enter+" seconds");
			}
		}
    }
    ...
    public String getMasterTablePlatformId(String masterTableId) {
		...
		try {
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getMasterTablePlatformId takes " + enter+" seconds");
			}
		}
    }
    ...
    public ArrayList<String> getProbeSetIdBySymbols(String[] symbols, String platformId) {
		...
		try {
		    ...
		    if (debug)
		    	System.out.println("MySQLNGDDAOImp.sql = "+queryString.toLowerCase()+" 1 arg = "+platformId);
			...
			if (performance) {
			    enter = (System.currentTimeMillis() - enter)/1000;
			    if (2 < enter)
				System.out.println("MySQLNGDDAOImp.getProbeSetIdBySymbols takes " + enter+" seconds");
			}
		}
    }
...
//		System.out.println("MySQLNGDDAOImp-findTissueBySubmissionId for " + submissionId);
		String tissue = null;
        ...
        try {
            ...
            prepStmt = parQ.getPrepStat();
		    if (debug)
		    	System.out.println("MySQLNGDDAOImp 1 arg = "+submissionId);
