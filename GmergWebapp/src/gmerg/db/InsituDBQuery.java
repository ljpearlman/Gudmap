...
public class InsituDBQuery {
	...
	final static String name3 = "INSITU_SUBMISSION_IMAGES_BY_IMAGE_ID";
	final static String query3 = "SELECT SUB_ACCESSION_ID, SUB_EMBRYO_STG, SPN_ASSAY_TYPE, CONCAT(I.URL_URL, IMG_FILEPATH, 'medium/',IMG_FILENAME), CONCAT(C.URL_URL, IMG_CLICK_FILEPATH, IMG_CLICK_FILENAME), CONCAT(SUB_OID,'_',IMG_FILENAME) " +
			"FROM ISH_SUBMISSION " +
			"JOIN ISH_ORIGINAL_IMAGE ON IMG_SUBMISSION_FK = SUB_OID " +
			"JOIN REF_URL I ON I.URL_OID = IMG_URL_FK " +
			"JOIN REF_URL C ON C.URL_OID = IMG_CLICK_URL_FK " +
