...
public class InsituDBQuery {
	...
	final static String query3 = "SELECT SUB_ACCESSION_ID, SUB_EMBRYO_STG, SPN_ASSAY_TYPE, CONCAT(I.URL_URL, IMG_FILEPATH, IMG_FILENAME), CONCAT(C.URL_URL, IMG_CLICK_FILEPATH, IMG_CLICK_FILENAME) " +
			"FROM ISH_SUBMISSION " +
			...
			"ORDER BY SUB_EMBRYO_STG, natural_sort(SUB_ACCESSION_ID), IMG_OID";
