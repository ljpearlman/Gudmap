...
//	final static String query3 = "SELECT DISTINCT MBC_STG_NAME FROM MIC_BROWSE_CACHE WHERE MBC_GNF_SYMBOL = ? ORDER BY NATURAL_SORT(MBC_STG_NAME) ";
    ...
    final static String query10 = "SELECT SER_GEO_ID, COUNT(distinct SRM_SAMPLE_FK), " +
    		"SER_TITLE, SER_SUMMARY, SER_TYPE, SER_OVERALL_DESIGN, SER_OID, GROUP_CONCAT(DISTINCT ANO_COMPONENT_NAME SEPARATOR ', '), " +
    		"SUB_ARCHIVE_ID, SUB_BATCH " +
	...
	final static String name43 = "GET_ALL_REF_GENELISTS_RNASEQ";
	final static String query43 = "SELECT GLS_OID,GLS_SHORT_NAME,GLS_LONG_NAME,GLS_DESCRIPTION,GLS_CLASS,GLS_SUBCLASS," +
	...
	final static String NGD_SAMPLE_SERIES_COLS = "SELECT DISTINCT SUB_ACCESSION_ID, NGS_GEO_ID, NGS_SAMPLE_NAME, NGP_LIBRARY_STRATEGY, "+
			"CASE NGS_SPECIES WHEN 'Homo sapiens' THEN '' ELSE "+
			"(CASE NGS_GENOTYPE WHEN 'true' THEN 'wild type' ELSE '' END) END AS GENOTYPE, NGS_DESCRIPTION, " +
    		"GROUP_CONCAT(DISTINCT ANO_COMPONENT_NAME SEPARATOR ', ')  ";
    ...
    final static String query34 = "SELECT NGR_GEO_ID, COUNT(distinct NGL_SAMPLE_FK), NGR_TITLE, NGR_SUMMARY, NGR_OVERALL_DESIGN, SUB_ARCHIVE_ID, SUB_BATCH " + 
	...
	final static String name36 = "GENOTYPE_LIST_ARRAY";
	final static String query36 = "SELECT DISTINCT SUB_ACCESSION_ID, ALE_ALLELE_NAME, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, MIC_SAMPLE, MIC_SERIES_SAMPLE, " +
								  "MIC_SERIES, ISH_SUBMISSION  WHERE SER_OID = ? AND SER_OID = SRM_SERIES_FK AND SRM_SAMPLE_FK = SMP_OID " +
								  "AND SMP_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID AND ALE_ALLELE_NAME IS NOT NULL " +
								  "UNION SELECT DISTINCT SUB_ACCESSION_ID, ALE_LAB_NAME_ALLELE, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, MIC_SAMPLE, MIC_SERIES_SAMPLE, " +
								  "MIC_SERIES, ISH_SUBMISSION  WHERE SER_OID = ? AND SER_OID = SRM_SERIES_FK AND SRM_SAMPLE_FK = SMP_OID " +
	...
	final static String name37 = "GENOTYPE_LIST_NGD";
	final static String query37 = "SELECT DISTINCT SUB_ACCESSION_ID, ALE_ALLELE_NAME, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, NGD_SAMPLE, NGD_SAMPLE_SERIES, " +
								  "NGD_SERIES, ISH_SUBMISSION  WHERE NGR_OID = ? AND NGR_OID = NGL_SERIES_FK AND NGL_SAMPLE_FK = NGS_OID " +
								  "AND NGS_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID AND ALE_ALLELE_NAME IS NOT NULL " +
								  "UNION SELECT DISTINCT SUB_ACCESSION_ID, ALE_LAB_NAME_ALLELE, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, NGD_SAMPLE, NGD_SAMPLE_SERIES, " +
								  "NGD_SERIES, ISH_SUBMISSION  WHERE NGR_OID = ? AND NGR_OID = NGL_SERIES_FK AND NGL_SAMPLE_FK = NGS_OID " +
								  "AND NGS_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID " +
								  "AND ALE_LAB_NAME_ALLELE IS NOT NULL ORDER BY SUB_ACCESSION_ID, SAL_ORDER";
	
	final static String name38 = "GENOTYPE_LIST_NGD_GE0";
	final static String query38 = "SELECT DISTINCT SUB_ACCESSION_ID, ALE_ALLELE_NAME, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, NGD_SAMPLE, NGD_SAMPLE_SERIES, " +
								  "NGD_SERIES, ISH_SUBMISSION  WHERE NGR_GEO_ID = ? AND NGR_OID = NGL_SERIES_FK AND NGL_SAMPLE_FK = NGS_OID " +
								  "AND NGS_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID AND ALE_ALLELE_NAME IS NOT NULL " +
								  "UNION SELECT DISTINCT SUB_ACCESSION_ID, ALE_LAB_NAME_ALLELE, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, NGD_SAMPLE, NGD_SAMPLE_SERIES, " +
								  "NGD_SERIES, ISH_SUBMISSION  WHERE NGR_GEO_ID = ? AND NGR_OID = NGL_SERIES_FK AND NGL_SAMPLE_FK = NGS_OID " +
								  "AND NGS_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID " +
	...
	final static String name39 = "GENOTYPE_LIST_ARRAY_GEO";
	final static String query39 = "SELECT DISTINCT SUB_ACCESSION_ID, ALE_ALLELE_NAME, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, MIC_SAMPLE, MIC_SERIES_SAMPLE, " +
								  "MIC_SERIES, ISH_SUBMISSION  WHERE SER_GEO_ID = ? AND SER_OID = SRM_SERIES_FK AND SRM_SAMPLE_FK = SMP_OID " +
								  "AND SMP_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID AND ALE_ALLELE_NAME IS NOT NULL " +
								  "UNION SELECT DISTINCT SUB_ACCESSION_ID, ALE_LAB_NAME_ALLELE, SAL_ORDER FROM ISH_ALLELE, LNK_SUB_ALLELE, MIC_SAMPLE, MIC_SERIES_SAMPLE, " +
								  "MIC_SERIES, ISH_SUBMISSION  WHERE SER_GEO_ID = ? AND SER_OID = SRM_SERIES_FK AND SRM_SAMPLE_FK = SMP_OID " +
								  "AND SMP_SUBMISSION_FK = SUB_OID AND SAL_ALE_OID_FK=ALE_OID AND SAL_SUBMISSION_FK=SUB_OID " +
