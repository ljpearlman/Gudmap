 ...
 *
 */
public class FocusBrowseNGDAssembler extends OffMemoryTableAssembler{
	...
	public FocusBrowseNGDAssembler () {
	      	if (debug)
	    System.out.println("FocusBrowseNGDAssembler.constructor");

	}
	
	public FocusBrowseNGDAssembler (HashMap params) {
		super(params);
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.constructor with params");

	}

	public void setParams() {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.setParams");
	...
	public DataItem[][] retrieveData(int column, boolean ascending, int offset, int num) {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.retrieveData");

	    if (null != cache && cache.isSameQuery(column, ascending, offset, num)) {
			if (debug)
			    System.out.println("FocusBrowseNGDAssembler.retriveData data not changed");
	...
	public int retrieveNumberOfRows() {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.retrieveNumberOfRows");
    ...
    public int[] retrieveTotals() {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.retrieveTotals");
		// force new data
		cache = null;
	...
	public HeaderItem[] createHeader() {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.createHeader");
	...
	public ArrayList[][] getStageList(String[] stage) {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.getStageList stage");
		...
		try{
			...
			System.out.println("FocusBrowseNGDAssembler::getStageList !!!");
			return null;
		}
		finally{
			DBHelper.closeJDBCConnection(conn);
	...
	public String[][] getStageList(String[] stage, String organ) {
		if (debug)
		    System.out.println("FocusBrowseNGDAssembler.getStageList stage organ");
