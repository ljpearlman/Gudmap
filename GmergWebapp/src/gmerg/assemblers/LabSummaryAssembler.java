...
//				arrayDAO.getSubmissionsByLabId(labId, submissionDate, column, ascending, offset, num);
			ArrayList arrayBrowseSubmissions =
...
//				ishDAO.getSubmissionsForAnnotationByLabId(labId, assayType, submissionDate, column, ascending, offset, num, isPublic);
			ishBrowseSubmissions = 
				ishDAO.getSubmissionsForAnnotationByLabId(labId, assayType, submissionDate, archiveId, column, ascending, offset, num, isPublic);
		} else {		
			// get data
//			ishBrowseSubmissions = 
//				ishDAO.getSubmissionsByLabId(labId, assayType, submissionDate, column, ascending, offset, num);
			ishBrowseSubmissions = 
...
//			numberOfRows = focusForAllDAO.getNumberOfSubmissionsForLabForAnnotation(labId, assayType, submissionDate, isPublic);
			numberOfRows = focusForAllDAO.getNumberOfSubmissionsForLabForAnnotation(labId, assayType, submissionDate, archiveId, isPublic);
		} else {
//			numberOfRows = focusForAllDAO.getNumberOfSubmissionsForLab(labId, assayType, submissionDate);
...
//		}
		...
		LabSummary[] labSummaries = new LabSummary[piNumber];
...
//			for (int k=0;k<SubmissionSummaryInDB.size();k++) {
//				System.out.println("db summary Size: " +((String[])SubmissionSummaryInDB.get(k)).length);
//				String[] item = (String[])SubmissionSummaryInDB.get(k);
//				for (int j=0;j<((String[])SubmissionSummaryInDB.get(k)).length;j++)
//					System.out.println("item: " +item[j]);
//			}
//			for (int k=0;k<SubmissionSummaryInFTPRaw.size();k++) {
//				System.out.println("ftp summary Size: " +((String[])SubmissionSummaryInFTPRaw.get(k)).length);
//				String[] item = (String[])SubmissionSummaryInFTPRaw.get(k);
//				for (int j=0;j<((String[])SubmissionSummaryInFTPRaw.get(k)).length;j++)
//					System.out.println("item: " +item[j]);	
//			}
...
//			for (int k=0;k<SubmissionSummaryInFTPRefined.size();k++) {
//				System.out.println("refined ftp summary Size: " +((String[])SubmissionSummaryInFTPRefined.get(k)).length);
//				String[] item = (String[])SubmissionSummaryInFTPRefined.get(k);
//				for (int j=0;j<((String[])SubmissionSummaryInFTPRefined.get(k)).length;j++)
//				System.out.println("item: " +item[j]);	
//			}
			summaryInTotal =
				getSubmissionSummary(SubmissionSummaryInFTPRefined, SubmissionSummaryInDB);
//			System.out.println("after summaryinTotal");				
//			for (int k=0;k<summaryInTotal.size();k++) {
//				System.out.println("summaryinTotal Size: " +((String[])summaryInTotal.get(k)).length);
//				String[] item = (String[])summaryInTotal.get(k);
//				for (int j=0;j<((String[])summaryInTotal.get(k)).length;j++)
//				System.out.println("item: " +item[j]);	
//			}
...
//					summaryInTotal =
//						getSubmissionSummary(SubmissionSummaryInFTPRefined, SubmissionSummaryInDB2, new int[]{4,5,19,20,21,22,23,24,25}, false);			
					summaryInTotal =
...
//										if (summaryInFTP[2].equals("TG")) {
//											System.out.println("TG:find entries#####");
//											System.out.println("TG:date: " + summaryInFTP[0]);
//											System.out.println("TG:number: " + summaryInDB[1]);
//											System.out.println("TG:status: " + Integer.toString(dbStatus[k]));
//										}
//										String[] summaryAvailable =  new String[4];
					...
					if (!inDB) {
						...
						if(null != summaryInFTP[2] && (summaryInFTP[2].equals("IHC") || summaryInFTP[2].equals("ISH") || summaryInFTP[2].equals("TG"))) {
//							if (summaryInFTP[2].equals("TG")) {
//								System.out.println("TG:not in DB#####");
//								System.out.println("TG:date: " + summaryInFTP[0]);
//								System.out.println("TG:number: " + summaryInFTP[1]);
//								System.out.println("TG:status: " + Integer.toString(0));
//							}
						...
						if(null != summaryInFTP[2] && (summaryInFTP[2].equals("IHC") || summaryInFTP[2].equals("ISH") || summaryInFTP[2].equals("TG"))) {
//							if (summaryInFTP[2].equals("TG")) {
//								System.out.println("TG:not all in DB#####");
//								System.out.println("TG:date: " + summaryInFTP[0]);
//								System.out.println("TG:number: " + Integer.toString(submissionNumberNotInDB));
//								System.out.println("TG:status: " + Integer.toString(0));
//							}
