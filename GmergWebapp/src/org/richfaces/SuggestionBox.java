...
import gmerg.assemblers.SuggestionBoxAssembler;
...
public class SuggestionBox {
    ...
    protected SuggestionBoxAssembler assembler;
    ...
    public SuggestionBox() {
        ...
        assembler = new SuggestionBoxAssembler();
        treeContent = assembler.getWholeAnatomyTree("TS01", "TS26");
    ...
    public ArrayList getAllData(String pref) {
    	assembler = null;
    	assembler = new SuggestionBoxAssembler();
    	
    	ArrayList list = assembler.getAllAnatomyTerms(pref);
    	if(null == list)
    		list = new ArrayList();
        return list;
    }
